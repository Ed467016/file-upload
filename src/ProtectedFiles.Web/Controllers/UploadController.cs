...
namespace ProtectedFiles.Web.Controllers
{
    public class UploadController : Controller
    {
        ...
        [SessionAdminAuthorizationFilter(role: (int)Roles.Admin)]
        /// <param name="itemId">
        ...
        private async Task<IActionResult> UploadProtectedFileSafe(UploadFileViewModel uploadFileViewModel)
        {
            ...
            {
                item = new Item();
                item.ItemId = uploadFileViewModel.ItemId;
                exists = false;
            }
            ...
            {
                var fileName = item.ItemId + item.FileExtension;
